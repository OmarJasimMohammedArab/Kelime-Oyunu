...
public class WordsGrid : MonoBehaviour
{
    ...
    public float squareOffset = 8.8f;
    ...
    private void SpawnGridSquares()
    {
        if (currentGameData != null)
        {
            ...
            foreach (var squares in currentGameData.selectedBoarddata.Boards)
            {
                foreach (var squareLetter in squares.Row)
                {
                    ...
                    {
                        Debug.Log("All fieldes in your arrya should have some letter" + squareLetter);
